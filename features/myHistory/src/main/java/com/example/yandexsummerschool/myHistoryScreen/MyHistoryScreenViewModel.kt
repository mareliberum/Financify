...
class MyHistoryScreenViewModel @Inject constructor(
    ...
    private var transactionsType: com.example.yandexsummerschool.ui.common.TransactionType? =
        null // Историю чего мы отображаем - доходы или расходы
    ...
    fun loadHistory(type: com.example.yandexsummerschool.ui.common.TransactionType) {
        loadingJob?.cancel()
        loadingJob =
    ...
    private suspend fun getResult(type: com.example.yandexsummerschool.ui.common.TransactionType): Result<List<TransactionDomainModel>> {
        return when (type) {
            com.example.yandexsummerschool.ui.common.TransactionType.INCOME -> {
                getIncomesUseCase(
                    getAccountId(),
            ...
            com.example.yandexsummerschool.ui.common.TransactionType.EXPENSE -> {
                getExpensesUseCase(
                    getAccountId(),
                    convertUiDateToIso(startOfPeriod.value),
                    convertUiDateToIso(endOfPeriod.value),

package com.example.yandexsummerschool.features.accountScreen.components
...
import com.example.yandexsummerschool.account.R
...
fun BottomSheetContent(
    ...
    Column {
        ...
        ListItem(
            title = "Евро €",
            leadingIcon = painterResource(com.example.yandexsummerschool.common.R.drawable.eur_19),
            listItemSize = ListItemSize.BIG,
            leadingIconBackground = Color.Transparent,
            onClick = {
        ...
        ListItem(
            leadingIcon = painterResource(com.example.yandexsummerschool.common.R.drawable.cancel_20),
            title = "Отмена",
            listItemSize = ListItemSize.BIG,

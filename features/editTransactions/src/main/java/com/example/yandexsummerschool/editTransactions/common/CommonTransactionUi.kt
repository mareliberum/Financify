package com.example.yandexsummerschool.editTransactions.common
...
import com.example.yandexsummerschool.editTransactions.addTransactionScreen.AddTransactionScreenState
...
fun TransactionEditorScreenContent(
    ...
    onCategoryChange: (com.example.yandexsummerschool.domain.models.ArticleModel) -> Unit,
    articles: ImmutableList<com.example.yandexsummerschool.domain.models.ArticleModel>,
) {
...
fun ArticlesSheet(
	articles: ImmutableList<com.example.yandexsummerschool.domain.models.ArticleModel>,
	onSelect: (com.example.yandexsummerschool.domain.models.ArticleModel) -> Unit,
	onDismiss: () -> Unit,
) {
